...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                <a href="{{ route('admin.products.index') }}" class="@if(request()->is('admin/products*')) active @endif">
                    <span>📦</span>
                    <span>Produk</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.reviews.index') }}" class="@if(request()->is('admin/reviews*')) active @endif">
                    <span>⭐</span>
                    <span>Ulasan</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.content.index') }}" class="@if(request()->is('admin/content*')) active @endif">
                    <span>📝</span>
                    <span>Kelola Konten</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.settings.social') }}" class="@if(request()->is('admin/settings/social*')) active @endif">
                    <span>🌐</span>
                    <span>Media Sosial</span>
                </a>
            </li>
            <li>
                <a href="{{ route('admin.settings') }}" class="@if(request()->is('admin/settings') && !request()->is('admin/settings/social*')) active @endif">
                    <span>⚙️</span>
